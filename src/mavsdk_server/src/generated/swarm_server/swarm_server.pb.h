...
PROTOBUF_NAMESPACE_OPEN
template<> ::mavsdk::rpc::swarm_server::PositionGlobalYaw* Arena::CreateMaybeMessage<::mavsdk::rpc::swarm_server::PositionGlobalYaw>(Arena*);
...
class SubscribePositionTargetGlobalResponse final :
 ...
 public:
  ...
  const ::mavsdk::rpc::swarm_server::PositionGlobalYaw& position_global_yaw() const;
  PROTOBUF_NODISCARD ::mavsdk::rpc::swarm_server::PositionGlobalYaw* release_position_global_yaw();
  ::mavsdk::rpc::swarm_server::PositionGlobalYaw* mutable_position_global_yaw();
  void set_allocated_position_global_yaw(::mavsdk::rpc::swarm_server::PositionGlobalYaw* position_global_yaw);
  private:
  const ::mavsdk::rpc::swarm_server::PositionGlobalYaw& _internal_position_global_yaw() const;
  ::mavsdk::rpc::swarm_server::PositionGlobalYaw* _internal_mutable_position_global_yaw();
  public:
  void unsafe_arena_set_allocated_position_global_yaw(
      ::mavsdk::rpc::swarm_server::PositionGlobalYaw* position_global_yaw);
  ::mavsdk::rpc::swarm_server::PositionGlobalYaw* unsafe_arena_release_position_global_yaw();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::mavsdk::rpc::swarm_server::PositionGlobalYaw* position_global_yaw_;
...
class PositionGlobalYaw final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.swarm_server.PositionGlobalYaw) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "mavsdk.rpc.swarm_server.PositionGlobalYaw";
  }
  protected:
  ...
  ::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType altitude_type() const;
  void set_altitude_type(::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType value);
  private:
  ::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType _internal_altitude_type() const;
  void _internal_set_altitude_type(::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType value);
  public:

  // @@protoc_insertion_point(class_scope:mavsdk.rpc.swarm_server.PositionGlobalYaw)
 private:
  class _Internal;
...
inline const ::mavsdk::rpc::swarm_server::PositionGlobalYaw& SubscribePositionTargetGlobalResponse::_internal_position_global_yaw() const {
  const ::mavsdk::rpc::swarm_server::PositionGlobalYaw* p = position_global_yaw_;
  return p != nullptr ? *p : reinterpret_cast<const ::mavsdk::rpc::swarm_server::PositionGlobalYaw&>(
      ::mavsdk::rpc::swarm_server::_PositionGlobalYaw_default_instance_);
}
inline const ::mavsdk::rpc::swarm_server::PositionGlobalYaw& SubscribePositionTargetGlobalResponse::position_global_yaw() const {
...
inline ::mavsdk::rpc::swarm_server::PositionGlobalYaw* SubscribePositionTargetGlobalResponse::release_position_global_yaw() {
  
  ::mavsdk::rpc::swarm_server::PositionGlobalYaw* temp = position_global_yaw_;
  position_global_yaw_ = nullptr;
...
inline ::mavsdk::rpc::swarm_server::PositionGlobalYaw* SubscribePositionTargetGlobalResponse::unsafe_arena_release_position_global_yaw() {
...
inline ::mavsdk::rpc::swarm_server::PositionGlobalYaw* SubscribePositionTargetGlobalResponse::_internal_mutable_position_global_yaw() {
  
  if (position_global_yaw_ == nullptr) {
    auto* p = CreateMaybeMessage<::mavsdk::rpc::swarm_server::PositionGlobalYaw>(GetArenaForAllocation());
    position_global_yaw_ = p;
  }
  return position_global_yaw_;
}
inline ::mavsdk::rpc::swarm_server::PositionGlobalYaw* SubscribePositionTargetGlobalResponse::mutable_position_global_yaw() {
  ::mavsdk::rpc::swarm_server::PositionGlobalYaw* _msg = _internal_mutable_position_global_yaw();
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.swarm_server.SubscribePositionTargetGlobalResponse.position_global_yaw)
  return _msg;
}
inline void SubscribePositionTargetGlobalResponse::set_allocated_position_global_yaw(::mavsdk::rpc::swarm_server::PositionGlobalYaw* position_global_yaw) {
...
inline double PositionGlobalYaw::lat_deg() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.swarm_server.PositionGlobalYaw.lat_deg)
...
inline void PositionGlobalYaw::set_lat_deg(double value) {
  ...
  // @@protoc_insertion_point(field_set:mavsdk.rpc.swarm_server.PositionGlobalYaw.lat_deg)
}
...
inline double PositionGlobalYaw::lon_deg() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.swarm_server.PositionGlobalYaw.lon_deg)
...
inline void PositionGlobalYaw::set_lon_deg(double value) {
  ...
  // @@protoc_insertion_point(field_set:mavsdk.rpc.swarm_server.PositionGlobalYaw.lon_deg)
}
...
inline float PositionGlobalYaw::alt_m() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.swarm_server.PositionGlobalYaw.alt_m)
...
inline void PositionGlobalYaw::set_alt_m(float value) {
  ...
  // @@protoc_insertion_point(field_set:mavsdk.rpc.swarm_server.PositionGlobalYaw.alt_m)
}
...
inline float PositionGlobalYaw::yaw_deg() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.swarm_server.PositionGlobalYaw.yaw_deg)
...
inline void PositionGlobalYaw::set_yaw_deg(float value) {
  ...
  // @@protoc_insertion_point(field_set:mavsdk.rpc.swarm_server.PositionGlobalYaw.yaw_deg)
}
...
inline ::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType PositionGlobalYaw::_internal_altitude_type() const {
  return static_cast< ::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType >(altitude_type_);
}
inline ::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType PositionGlobalYaw::altitude_type() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.swarm_server.PositionGlobalYaw.altitude_type)
  return _internal_altitude_type();
}
inline void PositionGlobalYaw::_internal_set_altitude_type(::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType value) {
  
  altitude_type_ = value;
}
inline void PositionGlobalYaw::set_altitude_type(::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType value) {
  _internal_set_altitude_type(value);
  // @@protoc_insertion_point(field_set:mavsdk.rpc.swarm_server.PositionGlobalYaw.altitude_type)
}
...
template <> struct is_proto_enum< ::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType>() {
  return ::mavsdk::rpc::swarm_server::PositionGlobalYaw_AltitudeType_descriptor();
}
